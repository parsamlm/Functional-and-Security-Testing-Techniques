...
public class DashboardPO {
    ...
    public void set_CSSSELECTOR_trnth_child4tdnth_child1() {
        By elem = By.cssSelector("tr:nth-child(4) > td:nth-child(1)");
        MyUtils.WaitForElementLoaded(driver, elem);
    }

    public void doNewContent(String key1) {
        click_LINKTEXT_Newcontent();
        set_ID_jstitle(key1);
        click_CSSSELECTOR_uk_buttonnth_child1();
        set_CSSSELECTOR_trnth_child4tdnth_child1();
    }
    ...
    public String set_LINKTEXT_TestContent_1() {
        By elem = By.linkText("Test Content");
        MyUtils.WaitForElementLoaded(driver, elem);
    ...
    public void click_ID_jstitle() {
        By elem = By.id("jstitle");
        MyUtils.WaitForElementLoaded(driver, elem);
        driver.findElement(elem).click();
        {
            elem = By.id("jsSaveDraft");
            MyUtils.WaitForElementLoaded(driver, elem);
            WebElement element = driver.findElement(elem);
    ...
    public void click_ID_jstitle_1(String key1) {
        By elem = By.id("jstitle");
        MyUtils.WaitForElementLoaded(driver, elem);
        driver.findElement(elem).clear();
        driver.findElement(elem).sendKeys(key1);
    ...
    public void set_ID_jsSaveDraft() {
        By elem = By.id("jsSaveDraft");
        MyUtils.WaitForElementLoaded(driver, elem);
        driver.findElement(elem).click();
    }

    public void doAddNewDraft(String key1) {
        click_CSSSELECTOR_uk_row_firstuk_panelnth_child1a();
        click_ID_jstitle();
        click_ID_jstitle_1(key1);
        set_ID_jsSaveDraft();
    }
    ...
    public void doChangePositionOfContent(String key1) {
        click_LINKTEXT_Content();
        click_LINKTEXT_TestContent();
        click_CSSSELECTOR_linth_child7sidebar_button();
    ...
    public boolean isFollowBluditLinkAvailable() {
        By elem = By.linkText("Follow Bludit");
        try {
            MyUtils.WaitForElementLoaded(driver, elem);
            return true;
    ...
    public void doSetAContentAsSticky(String key1) {
        click_LINKTEXT_Content();
