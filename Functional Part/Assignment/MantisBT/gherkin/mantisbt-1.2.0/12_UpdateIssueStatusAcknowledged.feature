...
Scenario: Changes the status of an issue to "acknowledged"
	...
	When the user clicks the "View Issues" link
		...
		And selects "acknowledged" in the "Status" dropdown select
		And clicks the "Update Information" button
	Then "acknowledged" is shown to the right of "Status"
